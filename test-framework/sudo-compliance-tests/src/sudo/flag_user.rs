...
#[test]
fn root_can_become_another_user_by_name() {
...
#[test]
fn user_can_become_another_user() {
...
#[test]
fn invoking_user_groups_are_lost_when_becoming_another_user() {
    let invoking_user = USERNAME;
    let another_user = "another_user";
    let env = Env(SUDOERS_USER_ALL_NOPASSWD)
        .group(GROUPNAME)
...
#[test]
fn unassigned_user_id_is_rejected() {
